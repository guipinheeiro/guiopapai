    ...
    return (
        ...
        <Box as="main" h="100vh" p={4} color={'gui.seasalt'} textStyle="body" flexDirection="column">
            ...
            <Text textStyle="h2" mb={4}>
                 <Text as="span" color={'gui.orange'}>Instalando</Text> o R5
            </Text>
            <Text mb={4}>
            ...
            <OrderedList mb={4}>
                <ListItem>
                    Clique <Link Link href="https://4mp1r5-my.sharepoint.com/personal/r5reloaded_4mp1r5_onmicrosoft_com/_layouts/15/onedrive.aspx?id=%2Fpersonal%2Fr5reloaded%5F4mp1r5%5Fonmicrosoft%5Fcom%2FDocuments%2FR5Reloaded%2E7z&parent=%2Fpersonal%2Fr5reloaded%5F4mp1r5%5Fonmicrosoft%5Fcom%2FDocuments&ga=1" isExternal ><Text as={'span'} fontWeight={'700'} color={'gui.green'}>AQUI</Text></Link> e baixe a build original do <Text as={'span'} fontWeight={'600'}>R5Reloaded</Text>.
                </ListItem>
                <ListItem>
                    Faça a descompactação dos arquivos baixados.
                </ListItem>
                <ListItem>
                    Clique <Link Link href="https://github.com/M1kep/R5ReloadedInstaller/releases/download/v0.15.1/r5util-v0.15.1-windows-amd64.zip" isExternal ><Text as={'span'} fontWeight={'700'} color={'gui.green'}>AQUI</Text></Link> e baixe o <Text as={'span'} fontWeight={'600'}>R5Util</Text> no formato ZIP.
                </ListItem>
                <ListItem>
                    <Text as={'span'} fontWeight={'700'} color={'gui.bloodred'}>IMPORTANTE:</Text> Extraia os arquivos do R5Util para a mesma pasta onde você extraiu o R5Reloaded.
                </ListItem>
                <ListItem>
                    Clique duas vezes em R5Util.exe e aguarde a instalação dos scripts.
                </ListItem>
